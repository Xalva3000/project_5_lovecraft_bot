LEXICON_default: dict[str, str] = {
    ...
    """Внизу имеется кнопка МЕНЮ, со списком команд.
    
    Основные команды 3:
        1 - читать "Молитва и Намерение"
        2 - случайный отрывок (из первоисточников)
        3 - игра "Словарь" (более 440 терминов).
             
    Остальные команды вспомогательные:
        закладки, добавить отрывок, добавить термин в словарь.
             
    При чтении текстов встретится кнопка "🔊":
        это озвучивание текста, 
        нажми и немного подожди 
        пока сформируется аудио файл.
             
    Если команда недоступна:
        нажми "отмену области команд" в меню.
    """),
