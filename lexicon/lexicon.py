...
LEXICON_dict: dict[str, str] = {
    ...
    "need_more_terms": """В базе данных недостаточно терминов
            ...
            в главном меню.""",
    "term_already_exists": "Термин имеется в словаре."
}
...
LEXICON_reading_book: dict[str, str] = {
    ...
    "no_term": "Такого термина нет в словаре.",
    "multiple_results": "Множественное значение. Обратитесь к администратору"
}
